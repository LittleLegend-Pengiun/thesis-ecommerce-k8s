...
\noindent Để hiện thực Prometheus server, ta cần làm theo các bước sau:\footnote{https://devopscube.com/setup-prometheus-monitoring-on-kubernetes/}\\[0.5cm]
\textbf{Bước 1:} Tạo Namespace và ClusterRole.\\[0.5cm]
Để làm rạch ròi 
\subsection{Kiểm thử}
