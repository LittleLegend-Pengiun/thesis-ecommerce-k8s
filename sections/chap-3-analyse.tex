...
\noindent \textbf{Ghi chú:} Đây chỉ là sơ đồ cho chức năng liên quan đến sản phẩm
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \item \textbf{Product Category:} Thực thể này lưu trữ thông tin về loại sản phẩm của cửa hàng.
            \begin{table}[H]
                ...
                created\_at         & timestamp             & Thời gian tạo                 \\ \hline
                \end{tabular}
                \caption{Bảng mô tả Product Catagory}
                \label{table:1}
                \end{table}
    \item \textbf{Product Inventory:} Thực thể này lưu trữ thông tin về kho lưu trữ sản phẩm của cửa hàng.
        ...
        created\_at         & timestamp             & Thời gian tạo                 \\ \hline
        \end{tabular}
        \caption{Bảng mô tả Product Inventory}
        \label{table:1}
        \end{table}
    \item \textbf{Discount:} Thực thể này lưu trữ thông tin về khuyến mãi của sản phẩm.
        ...
        Modified\_at        & timestamp             & Thời gian điều chỉnh     \\ \hline
        \end{tabular}
        \caption{Bảng mô tả Discount}
        \label{table:1}
        \end{table}
    \item \textbf{Attribute:} Đây là một thực thể yếu (phụ thuộc vào từng sản phẩm), nó lưu trữ thông tin thuộc tính của sản phẩm
        \begin{table}[H]
            \begin{tabular}{|l|l|l|}
            \hline
            \textbf{Thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Mô tả}         \\ \hline
            attribute\_name     & varchar               & Tên thuộc tính         \\ \hline
            value               & text                  & Giá trị của thuộc tính \\ \hline
            \end{tabular}
            \caption{Bảng mô tả Attribute}
        \label{table:1}
        \end{table}
\end{itemize}
